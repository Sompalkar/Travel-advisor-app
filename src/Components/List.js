    ...
    >
      ...
      <div className="  ">
        <div className="card-body p-4 ">
          ...
          <p className="card-text fs-8 mt-2 m-0 ">
          ...
          <div className="d-flex justify-content-between align-items-center">
            ...
            <a
              href={el.website}
              target="_blank"
              className="card-text fs-8 mt-2 m-0 "
            >
              Visit WebSite
            </a>
          </div>
          <div className="row align-items-center mt-3  m-0 ">
            <span className="d-flex fs-7 gap-3  col-3 justify-content-center">
              <p className="m-0 p-0">
                {" "}
                <Location />
              </p>
